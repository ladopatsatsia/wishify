    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 flex items-center justify-center p-4">
      ...
      {step === 'success' ? (
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl p-10 max-w-sm w-full text-center animate-bounce-in">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-3">Card is Live!</h2>
          <p className="text-slate-500 font-medium mb-2">Your gift is now live at:</p>
          <div className="bg-violet-50 rounded-xl px-4 py-3 font-mono text-violet-700 font-bold text-sm break-all mb-6">
            http://{slug}.{hostname}
          </div>
          <p className="text-slate-400 text-sm animate-pulse">Redirecting to your published cards…</p>
        </div>
      ) : (
        /* ─── Checkout ─── */
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] shadow-2xl p-8 max-w-md w-full flex flex-col gap-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-2xl font-black text-white">Publish Your Gift Card</h1>
            <p className="text-white/50 text-sm mt-1">One-time premium publishing fee</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-violet-600 to-pink-600 rounded-2xl p-5 shadow-xl shadow-violet-900/40">
            <div className="text-white/60 text-xs font-bold uppercase tracking-widest mb-6">Payment Card</div>
